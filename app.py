...
def chat():
    ...
    system_prompt = (
        ...
        "- PharmaACE Innovations - Intern (June 2026 - Present): Engineering Agentic AI systems and multi-stage orchestration pipelines. Designing and implementing retrieval-augmented generation (RAG) pipelines, robust data processing, and prompt engineering components.\n"
        ...
        "4. PaisaWise: Privacy-first, automated personal finance manager parsing bank transaction SMS alerts locally on-device, applying custom rules, heuristics, and LLM classifiers to separate personal spending from investments, transfers, and family cashflows. Code: https://github.com/shlokbam/PaisaWise\n"
        "5. PromptVault: Centralized prompt management & version control platform for AI Agent teams featuring Monaco editor workspace, side-by-side version diffing, test suites, comments, and audit trails. Code: https://github.com/shlokbam/PromptVault\n"
        "6. Generative AI RAG PDF Hub: A full Generative AI RAG pipeline where recruiters can upload PDFs and ask questions. Deployed at: https://generativeai-rag.streamlit.app/\n"
        "7. AI Surveillance Poaching Detection: AI surveillance system using Computer Vision to detect poachers and send instant email alerts.\n"
        "8. AI-powered Mock Interview Platform: Interactive portal automating job interview questions and scoring using Vue/React.\n"
        "9. Full DevOps CI/CD Pipeline: Complete automated DevOps pipeline built from scratch to deploy high-availability apps.\n"
        "10. Predictive Maintenance App (HX97): Uses ML/AI models to predict machinery failures before they happen. Deployed at: https://predictive-maintenance-hx97.onrender.com/\n"
        "11. Multi-Constraint Genetic Algorithm: Specialized constraint solver using evolutionary computation. Deployed at: https://genetic-algorithm-multi-constraint.onrender.com/\n"
        "12. Inventory Management System: Fully-featured responsive store inventory database system. Deployed at: https://ims-frontend-udaw.onrender.com/login\n\n"
        "3+ PATENTS & RESEARCH:\n"
        ...
        "3. Patent — Next-Generation TKPH Tire Health Management System (IPO India): Co-Inventor. Published on 03/10/2025. Predictive tire health management framework combining AI-based TKPH analytics, blockchain-secured records, and digital-twin lifecycle monitoring.\n\n"
        "CERTIFICATIONS & COURSES:\n"
        "- McKinsey Forward Program (Completed December 2025): Professional development covering problem-solving, communication, adaptability, and digital readiness.\n"
        "- Google Cloud Data Analytics Certificate (Completed June 2025): BigQuery, data transformation, visualization, and cloud-based analytics.\n"
        "- AWS Cloud Practitioner Essentials (Completed July 2025): Cloud computing concepts, security, pricing, and services.\n\n"
        "ACHIEVEMENTS & RECOGNITIONS:\n"
        "- Google Arcade Program — Diamond League (2025): Earned 90+ badges and reached Diamond League rank for cloud skills.\n"
        "- INDOvateAI Sprint 2025: Outstanding Performance Award for IndoTrade (AI stock assistant).\n"
        "- Navdhara State Level Poster Competition (2024): Top 5 Finalist with Wildlife Poaching Detection System.\n"
        "- Old Age Home Volunteering (2023): Spent weekends supporting senior care near Katraj, Pune.\n\n"
